...
import 'eq8_model.dart';
export 'eq8_model.dart';

class Eq8Widget extends StatefulWidget {
  const Eq8Widget({
    super.key,
    this.isTrue,
    this.isAnswered,
  ...
  @override
  State<Eq8Widget> createState() => _Eq8WidgetState();
}

class _Eq8WidgetState extends State<Eq8Widget> {
  late Eq8Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Eq8Model());
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      FFLocalizations.of(context).getText(
                        'nzglz1sg' /* Which word rhymes with "cat"? */,
                      ),
