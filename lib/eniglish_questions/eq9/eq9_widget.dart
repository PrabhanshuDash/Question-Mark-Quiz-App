...
import 'eq9_model.dart';
export 'eq9_model.dart';

class Eq9Widget extends StatefulWidget {
  const Eq9Widget({
    super.key,
    this.isTrue,
    this.isAnswered,
  ...
  @override
  State<Eq9Widget> createState() => _Eq9WidgetState();
}

class _Eq9WidgetState extends State<Eq9Widget> {
  late Eq9Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Eq9Model());
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      FFLocalizations.of(context).getText(
                        'stdf1wm9' /* What is the opposite of "hot"? */,
                      ),
