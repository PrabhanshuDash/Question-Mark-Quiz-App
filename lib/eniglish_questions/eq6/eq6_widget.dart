...
import 'eq6_model.dart';
export 'eq6_model.dart';

class Eq6Widget extends StatefulWidget {
  const Eq6Widget({
    super.key,
    this.isTrue,
    this.isAnswered,
  ...
  @override
  State<Eq6Widget> createState() => _Eq6WidgetState();
}

class _Eq6WidgetState extends State<Eq6Widget> {
  late Eq6Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Eq6Model());
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      FFLocalizations.of(context).getText(
                        'e95f2cts' /* What is another word for "big"... */,
                      ),
