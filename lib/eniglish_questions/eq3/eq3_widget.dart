...
import 'eq3_model.dart';
export 'eq3_model.dart';

class Eq3Widget extends StatefulWidget {
  const Eq3Widget({
    super.key,
    this.isTrue,
    this.isAnswered,
  ...
  @override
  State<Eq3Widget> createState() => _Eq3WidgetState();
}

class _Eq3WidgetState extends State<Eq3Widget> {
  late Eq3Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Eq3Model());
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      FFLocalizations.of(context).getText(
                        '6qu93neo' /* Which word is a pronoun? */,
                      ),
