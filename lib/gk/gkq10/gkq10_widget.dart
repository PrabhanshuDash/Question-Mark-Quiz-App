...
import 'gkq10_model.dart';
export 'gkq10_model.dart';

class Gkq10Widget extends StatefulWidget {
  const Gkq10Widget({
    super.key,
    this.isTrue,
    this.isAnswered,
  ...
  @override
  State<Gkq10Widget> createState() => _Gkq10WidgetState();
}

class _Gkq10WidgetState extends State<Gkq10Widget> {
  late Gkq10Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Gkq10Model());
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      FFLocalizations.of(context).getText(
                        '67oam24n' /* What is the name of the Indian... */,
                      ),
