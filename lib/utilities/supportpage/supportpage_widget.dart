            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Text(
                    FFLocalizations.of(context).getText(
                      'tqgvh1le' /* Need help with the quiz or hav... */,
                    ),
                ...
                Padding(
                  ...
                  child: Text(
                    FFLocalizations.of(context).getText(
                      'od3si9zr' /* If you have more questions or ... */,
                    ),
                    style: FlutterFlowTheme.of(context).bodyMedium.override(
                          fontFamily: 'Readex Pro',
                          color: FlutterFlowTheme.of(context).secondaryText,
                  ...
                  child: TextFormField(
                    ...
                    decoration: InputDecoration(
                      ...
                      hintText: FFLocalizations.of(context).getText(
                        '9pczsp0r' /* Enter your email address... */,
                      ),
                      hintStyle:
                ...
                Padding(
                  ...
                  child: TextFormField(
                    ...
                    decoration: InputDecoration(
                      ...
                      hintText: FFLocalizations.of(context).getText(
                        'm4t7fo1b' /* Enter subject of your query... */,
                      ),
                      hintStyle:
                          FlutterFlowTheme.of(context).bodyLarge.override(
                                fontFamily: 'Readex Pro',
                ...
                Padding(
                  ...
                  child: TextFormField(
                    ...
                    decoration: InputDecoration(
                      ...
                      hintText: FFLocalizations.of(context).getText(
                        'ymuh1nsm' /* Type your message here... */,
                      ),
                      hintStyle:
                          FlutterFlowTheme.of(context).bodyLarge.override(
                                fontFamily: 'Readex Pro',
                ...
                Padding(
                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      await launchUrl(Uri(
                        scheme: 'mailto',
                        path: 'prabhanshudash@gmail.com',
                      ));
                    },
                    text: FFLocalizations.of(context).getText(
                      'kc5rywx8' /* Send Message */,
                    ),
              ...
              ].divide(const SizedBox(height: 14.0)).around(const SizedBox(height: 14.0)),
            ),
          ),
        ),
      ),
