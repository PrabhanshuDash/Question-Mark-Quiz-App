...
import 'mq9_model.dart';
export 'mq9_model.dart';

class Mq9Widget extends StatefulWidget {
  const Mq9Widget({
    super.key,
    this.isTrue,
    this.isAnswered,
  ...
  @override
  State<Mq9Widget> createState() => _Mq9WidgetState();
}

class _Mq9WidgetState extends State<Mq9Widget> {
  late Mq9Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Mq9Model());
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      FFLocalizations.of(context).getText(
                        '3by9won9' /* What is the sum of 9 and 11? */,
                      ),
