...
import 'mq6_model.dart';
export 'mq6_model.dart';

class Mq6Widget extends StatefulWidget {
  const Mq6Widget({
    super.key,
    this.isTrue,
    this.isAnswered,
  ...
  @override
  State<Mq6Widget> createState() => _Mq6WidgetState();
}

class _Mq6WidgetState extends State<Mq6Widget> {
  late Mq6Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Mq6Model());
