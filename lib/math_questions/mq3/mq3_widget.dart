...
import 'mq3_model.dart';
export 'mq3_model.dart';

class Mq3Widget extends StatefulWidget {
  const Mq3Widget({
    super.key,
    this.isTrue,
    this.isAnswered,
  ...
  @override
  State<Mq3Widget> createState() => _Mq3WidgetState();
}

class _Mq3WidgetState extends State<Mq3Widget> {
  late Mq3Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Mq3Model());
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      FFLocalizations.of(context).getText(
                        '5pvtc2wu' /* What is the product of 4 × 6? */,
                      ),
