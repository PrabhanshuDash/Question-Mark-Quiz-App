...
import 'mq1_model.dart';
export 'mq1_model.dart';

class Mq1Widget extends StatefulWidget {
  const Mq1Widget({
    super.key,
    this.isTrue,
    this.isAnswered,
  ...
  @override
  State<Mq1Widget> createState() => _Mq1WidgetState();
}

class _Mq1WidgetState extends State<Mq1Widget> {
  late Mq1Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Mq1Model());
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      FFLocalizations.of(context).getText(
                        'jqkls4wu' /* What is the result of 5 + 3? */,
                      ),
