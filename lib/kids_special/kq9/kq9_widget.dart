...
import 'kq9_model.dart';
export 'kq9_model.dart';

class Kq9Widget extends StatefulWidget {
  const Kq9Widget({
    super.key,
    this.isTrue,
    this.isAnswered,
  ...
  @override
  State<Kq9Widget> createState() => _Kq9WidgetState();
}

class _Kq9WidgetState extends State<Kq9Widget> {
  late Kq9Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Kq9Model());
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      FFLocalizations.of(context).getText(
                        '19itk0u5' /* What type of animal is Tom? */,
                      ),
