...
import 'kq1_model.dart';
export 'kq1_model.dart';
...
class _Kq1WidgetState extends State<Kq1Widget> {
  late Kq1Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Kq1Model());
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      FFLocalizations.of(context).getText(
                        'l326cmz7' /* What color is Dora the Explore... */,
                      ),
